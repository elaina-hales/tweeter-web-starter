...
const Register = () => {
  ...
  const doRegister = async () => {
    presenterRef.current!.doRegister(alias, password, firstName, lastName, imageBytes, imageFileExtension, rememberMe);
  };
  ...
  const inputFieldFactory = () => {
    return (
      <>
        ...
        <AuthenticationFields setAlias={setAlias} setPassword={setPassword} onChange={registerOnEnter}/>
